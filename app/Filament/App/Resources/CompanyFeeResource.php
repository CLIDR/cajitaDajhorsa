...
use App\Filament\App\Resources\CompanyFeeResource\Pages;
use App\Filament\App\Resources\CompanyFeeResource\RelationManagers;
...
class CompanyFeeResource extends Resource
{
    ...
    {
        dd(auth()->user()->getDefaultTenant(Company::class));
        return $form
            ->schema([
